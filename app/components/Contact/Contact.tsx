...
import vector from "@/assets/images/vector-footer.svg";
...
export default function Contact() {
  return (
    <section
      className="w-screen relative h-full flex flex-col items-center mt-10 py-10 xl:py-40"
      id="contact"
    >
      <div className="container w-full h-full">
        <div className="w-full px-5 xl:px-20 2xl:px-48 gap-16 flex flex-col">
          ...
          {/* Social icons below contact form (mobile) */}
      ...
      <img
        src={vector.src}
        className="absolute bottom-0 right-0 w-3/5 lg:w-2/5"
        alt="vector"
      />
    </section>
  );
